...
namespace ATISMobileRestful.Controllers
{
    ...
    {
        [HttpGet]
        public List<Models.Turns> GetTurns(Int64 YourMUId)
        {
            List<Models.Turns> _Turns = new List<Models.Turns>();
            try
            {
                var Lst = R2CoreTransportationAndLoadNotificationMClassTurnsManagement.GetTurns(R2CoreTransportationAndLoadNotificationMClassMobileUsersManagement.GetNSSMobileUser(YourMUId));
