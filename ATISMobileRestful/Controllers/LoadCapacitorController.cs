...
namespace ATISMobileRestful.Controllers
{
    ...
    {
        [HttpGet]
        public List<Models.LoadCapacitorLoad> GetLoadCapacitorLoads(Int64 YourAHId, Int64 YourAHSGId, Int64 YourProvinceId = Int64.MinValue, Int64 YourLoadCapacitorLoadsListType = 1)
        {
            ...
            try
            {
                ...
                Lst = R2CoreTransportationAndLoadNotificationMClassLoadCapacitorLoadManagement.GetLoadCapacitorLoads(YourAHId, YourAHSGId, YourLoadCapacitorLoadsListType is null ? Convert.ToInt64(AnnouncementHallAnnounceTimeTypes.AllOfLoadsWithoutSedimentedLoads) : Convert.ToInt64(YourAnnouncementHallAnnounceTimeTypes), false, true, R2CoreTransportationAndLoadNotificationLoadCapacitorLoadOrderingOptions.TargetProvince, Int64.MinValue, YourProvinceId);
