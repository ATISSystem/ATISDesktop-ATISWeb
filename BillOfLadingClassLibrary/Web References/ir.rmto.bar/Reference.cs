...
namespace BillOfLadingClassLibrary.ir.rmto.bar {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="BarInfoServiceAtisSoap", Namespace="http://tempuri.org/")]
    public partial class BarInfoServiceAtis : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public BarInfoServiceAtis() {
            this.Url = global::BillOfLadingClassLibrary.Properties.Settings.Default.BillOfLadingClassLibrary_ir_rmto_bar_BarInfoServiceAtis;
        ...
        /// <remarks/>
        public void GetFreighterBOLsCountAsync(string UserName, string Password, string FreighterCardNo, string FromDate, string FromTime) {
            this.GetFreighterBOLsCountAsync(UserName, Password, FreighterCardNo, FromDate, FromTime, null);
        }
        
        /// <remarks/>
        public void GetFreighterBOLsCountAsync(string UserName, string Password, string FreighterCardNo, string FromDate, string FromTime, object userState) {
            if ((this.GetFreighterBOLsCountOperationCompleted == null)) {
                this.GetFreighterBOLsCountOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetFreighterBOLsCountOperationCompleted);
            }
            this.InvokeAsync("GetFreighterBOLsCount", new object[] {
                        UserName,
                        Password,
                        FreighterCardNo,
                        FromDate,
                        FromTime}, this.GetFreighterBOLsCountOperationCompleted, userState);
        }
        
        private void OnGetFreighterBOLsCountOperationCompleted(object arg) {
            if ((this.GetFreighterBOLsCountCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetFreighterBOLsCountCompleted(this, new GetFreighterBOLsCountCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9037.0")]
    public delegate void GetFreighterBOLsCountCompletedEventHandler(object sender, GetFreighterBOLsCountCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9037.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetFreighterBOLsCountCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal GetFreighterBOLsCountCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
