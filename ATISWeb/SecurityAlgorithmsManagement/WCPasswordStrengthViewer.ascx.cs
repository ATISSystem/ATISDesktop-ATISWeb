...
{
    public partial class WCPasswordStrengthViewer : System.Web.UI.UserControl
    {

        private PasswordStrength pwdStrength = new PasswordStrength();
        ...
        public void WCRefresh()
        { SetPassword(string.Empty); }

        private void UpdateControl()
        {
            int score = pwdStrength.GetPasswordScore();
            LblPasswordStrength.Text = pwdStrength.GetPasswordStrength();
            int x1 = score * 4;
            int x2 = x1 + 99;
            if (x2 >= 500) x2 = 499;
            ...
            brush = new LinearGradientBrush(new Point(0, 0), new Point(200, 100), clr1, clr2);
            ...
            //ImgPasswordStrength.ImageUrl = System.Drawing.Image.FromStream(MS);
            //ImageSource.FromStream(() => new MemoryStream(IRawData.IRawData));
