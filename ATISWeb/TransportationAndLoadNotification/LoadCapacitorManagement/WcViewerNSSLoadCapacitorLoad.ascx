...
<div class="container-fluid p-1 border border-primary d-flex flex-column">
    ...
    <div class="d-flex flex-column">
        <div class="row">
            <div class="col-1 col-lg-1 R2FontBYekanSmall text-center" style="color: #CCCCCC"><span>توضیحات</span></div>
            <div class="col-1 col-lg-1 R2FontBYekanSmall text-center" style="color: #CCCCCC"><span>گیرنده</span></div>
            <div class="col-1 col-lg-2 R2FontBYekanSmall text-center" style="color: #CCCCCC"><span>آدرس</span></div>
            ...
            <div class="col-1 col-lg-1 R2FontBYekanSmall text-center" style="color: #CCCCCC"><span>بارگیر</span></div>
            <div class="col-1 col-lg-1 R2FontBYekanSmall text-center" style="color: #CCCCCC"><span>مقصد</span></div>
            <div class="col-1 col-lg-1 R2FontBYekanSmall text-center" style="color: #CCCCCC"><span>شرح بار</span></div>
