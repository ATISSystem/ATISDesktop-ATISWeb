...
Public Class UCActivateSMSOwner
    Inherits UCGeneral
...
#Region "General Properties"
    ...
    Public Property UCNSSCurrent As R2CoreStandardSoftwareUserStructure
        ...
        Set(value As R2CoreStandardSoftwareUserStructure)
            _UCNSSCurrent = value
            If value IsNot Nothing Then CButtonActivateSMSOwner.Enabled = True
        End Set
    End Property
...
#Region "Event Handlers"
    ...
    Private Sub CButtonActivateSMSOwner_Click(sender As Object, e As EventArgs) Handles CButtonActivateSMSOwner.Click
        Try
            CButtonActivateSMSOwner.Enabled = False
            ...
            Dim InstanceSMS = New R2CoreParkingSystemMCLassSMSManager
            InstanceSMS.ActivateSMSOwner(UCNSSCurrent, R2CoreGUIMClassGUIManagement.FrmMainMenu.UcUserImage.UCCurrentNSS.UserId)
            UCFrmMessageDialog.ViewDialogMessage(FrmcMessageDialog.DialogColorType.SuccessProccess, "سرویس اس ام اس کاربر فعال شد", "", FrmcMessageDialog.MessageType.PersianMessage, Nothing, Me)
