...
#Region "Subroutins And Functions"
    ...
    Protected Overrides Sub SetNSSProcess()
        Try
            SetProcess(R2CoreMClassProcessesManagement.GetNSSProcess(R2CoreParkingSystemProcesses.FrmcMoneyWalletTransferCharge))
...
#Region "Event Handlers"
    ...
    Private Sub UcButtonTransfer_UCClickedEvent() Handles UcButtonTransfer.UCClickedEvent
        Try
            ...
            R2CoreMClassLoggingManagement.LogRegister(New R2CoreStandardLoggingStructure(0, R2CoreLogType.Note, "انتقال موجودی انجام گرفت" + vbCrLf + UcMoneyWalletSource.UCGetTrafficCard.CardNo + " " + UcMoneyWalletTarget.UCGetTrafficCard.CardNo, UcMoneyWalletSource.UCGetTrafficCard.CardNo + " " + UcMoneyWalletTarget.UCGetTrafficCard.CardNo, 0, 0, 0, 0, R2CoreMClassLoginManagement.CurrentUserNSS.UserId, _DateTime.GetCurrentDateTimeMilladiFormated(), _DateTime.GetCurrentDateShamsiFull))
