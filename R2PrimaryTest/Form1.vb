...
Public Class Form1
    ...
    Private Sub Button10_Click(sender As Object, e As EventArgs) Handles Button10.Click
        'R2CoreTransportationAndLoadNotificationMClassLoadAllocationManagement.Prioritize(R2CoreTransportationAndLoadNotificationMClassTurnsManagement.GetNSSTurn(429793))
    End Sub
    ...
    '        R2CoreTransportationAndLoadNotification.LoadCapacitor.LoadCapacitorLoad.R2CoreTransportationAndLoadNotificationMClassLoadCapacitorLoadManagement.GetLoadCapacitorLoads(4, 3, 4, False, True, R2CoreTransportationAndLoadNotificationLoadCapacitorLoadOrderingOptions.TargetProvince, Int64.MinValue, 26)
    '        MessageBox.Show(123)
    '    Catch ex As Exception
    '        MessageBox.Show(ex.Message)
    ...
    'Private Sub UcPersianTextBoxPelak_UC13PressedEvent(PersianText As String)
    '    UcPersianTextBoxSerial.UCFocus()
    'End Sub

    'Private Sub UcPersianTextBoxSerial_UC13PressedEvent(PersianText As String)
    '    Button13.Focus()
    'End Sub
