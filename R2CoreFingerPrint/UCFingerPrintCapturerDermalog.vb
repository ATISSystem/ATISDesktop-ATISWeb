...
#Region "Subroutins And Functions"
    ...
    Public Sub New()
        ...
        Try
            Me.Enabled = R2CoreMClassConfigurationManagement.GetConfigBoolean(R2CoreFingerPrintConfigurations.VerifyIdentifyFPUCEnable, R2CoreMClassComputersManagement.GetNSSCurrentComputer.MId, 0)
    ...
    Private Sub UCDermalogInitializeScanner()
        Try
            ...
            DDevice = R2CoreFingerPrint.DermalogSystem.R2CoreFingerPrintMClassDermalogManagemet.DermalogInitializeScanner(DMessage)
    ...
    Private Sub BtnSaveFP_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnSaveFP.Click
        Try
            ...
            If mySD.ShowDialog = DialogResult.Cancel Then
                Exit Sub
            End If
            PicFingerPrint.Image.Save(R2CoreMClassConfigurationManagement.GetConfigString(R2CoreFingerPrintConfigurations.SaveFingerPrintsPath, R2CoreMClassComputersManagement.GetNSSCurrentComputer.MId, 0) + "FingerPrint" + mySD.FileName)
