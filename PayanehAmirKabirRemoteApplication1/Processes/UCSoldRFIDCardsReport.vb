...
Imports R2CoreWinFormRemoteApplications.InformationManagement

Public Class UCSoldRFIDCardsReport
    Inherits UCGeneral

    Private WS As R2PrimaryWS.R2PrimaryWebService = New R2PrimaryWS.R2PrimaryWebService
...
#Region "Event Handlers"
    ...
    Private Sub UcDateTimeHolder_UCDoCommand() Handles UcDateTimeHolder.UCDoCommand
        Try
            ...
            R2CoreWinFormRemoteApplicationsMClassInformationManagement.PrintReport(PayanehAmirKabirRemoteApplicationClassLibrary.RdlName_SoldRFIDCardsReport)
        Catch ex As Exception
