...
#Region "Event Handlers"
    ...
    Private Sub UcDateTimeHolder_UCDoCommand() Handles UcDateTimeHolder.UCDoCommand
        Try
            ...
            R2CoreWinFormRemoteApplicationsMClassInformationManagement.PrintReport(PayanehAmirKabirRemoteApplicationClassLibrary.RdlName_ContractorCompanyFinancialReport)
        Catch ex As Exception
