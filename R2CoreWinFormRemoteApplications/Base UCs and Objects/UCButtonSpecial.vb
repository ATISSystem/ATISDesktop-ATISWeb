...
#Region "Event Handlers"
    Private Sub Button_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Button.KeyPress
        ...
        Catch ex As Exception
            _FrmMessageDialog.ViewDialogMessage(FrmcMessageDialog.DialogColorType.ErrorType,MethodBase.GetCurrentMethod().ReflectedType.FullName + "." + MethodBase.GetCurrentMethod().Name + vbCrLf + ex.Message, "", FrmcMessageDialog.MessageType.PersianMessage, Nothing, Me,false)
        End Try
